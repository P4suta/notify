...
| --- | --- | --- |
| Plain-text and JSON publish | Differential | Basic publish/poll, metadata, JSON, and webhook aliases are in the 47-case corpus. |
