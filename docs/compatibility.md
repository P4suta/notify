...
| --- | --- | --- |
| Plain-text and JSON publish | Differential | Basic publish/poll, metadata, JSON, webhook aliases, and authenticated publish/poll are in the 60-case corpus. |
